...
#define SCARA_LINKAGE_1 202.0f//200.0f //mm
#define SCARA_LINKAGE_2 196.0f //mm

// SCARA tower offset (position of Tower relative to bed zero position)
// This needs to be reasonably accurate as it defines the printbed position in the SCARA space.
#define SCARA_OFFSET_X -64.41 //-135mm
#define SCARA_OFFSET_Y 138.59//105mm	

#define MANUAL_X_HOME_POS -57.30f//-45.43f theta -81.46
#define MANUAL_Y_HOME_POS 93.83f //95.67f psi 67.67 si disminuye cierra.
